...
Invoke-WebRequest "https://raw.githubusercontent.com/blhatfield/SchoolMessenger/main/config_Student_ddcc.json" -Outfile 'C:\Program Files (x86)\SchoolMessenger\config.json'
